...
// LED Mod By Forrest Tindall 2024  www.forresttindall.com  https://github.com/forresttindall
...
// Define the maximum intensity for PWM (0-255)
...
int currentMode = 0;
int numModes = 8; // Update this to match the number of modes
...
void setup() {
  ...
  // Initialize the button pin as input with internal pullup
...
void buttonPressed() {
  // Increment mode and wrap around if it exceeds the number of modes
  currentMode = (currentMode + 1) % numModes;
}

// Strobe effect for each color
void strobeEffect() {
  // Red
  for (int i = 0; i <= MAX_INTENSITY; i++) {
    analogWrite(RED_PIN, i);
    delay(2); // Adjust the delay for faster pulsing
  }
...
// Alternate strobe effect for red and blue
...
// Strobe effect with purple color
